...
<%};%>
    ...
    <div class="mdl-card__actions mdl-card--border">
          <a class="mdl-button mdl-button--accent mdl-js-button mdl-js-ripple-effect" id="task-???" href="aplicacaolist.jsp?idTarefa=<%=t.getId()%>"><%=usu.isFreelancer()?"Inscrever":"Inscricoes"%></a>
<!-- Se for empresa, adiciona liinha de edicao -->
<%if(usu.isEmpresa()) {	%>
          <a class="mdl-button mdl-button--accent mdl-js-button mdl-js-ripple-effect" id="task-???" href="Manutencao?entidade=tarefa&id=<%=t.getId()%>">Alterar</a>
          <a class="mdl-button mdl-button--accent mdl-js-button mdl-js-ripple-effect" id="task-delete" href="Deletar?entidade=tarefa&id=<%=t.getId()%>">Deletar</a>
<%};%>
    </div>
  </div>
<% }%>
